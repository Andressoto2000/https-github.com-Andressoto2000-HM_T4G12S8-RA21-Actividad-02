...
@NamedQueries({
    ...
    @NamedQuery(name = "ServidorCorreoElectronico.findByLikeAsuntoMensaje", query = "SELECT s FROM ServidorCorreoElectronico s WHERE s.asuntoMensaje LIKE :asuntoMensaje")})
public class ServidorCorreoElectronico implements Serializable {
    ...
    public String toString() {
        return "co.edu.sena.horariosTecnica.domain.ServidorCorreoElectronico[ id=" + id + " ]";
    }
